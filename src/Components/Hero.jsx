...
const Hero = () => {
  return (
    <>
    <div id="home" style={{backgroundImage:'url(/image/abcdefg.jpg)'}} className='relative flex items-center justify-center bg-cover h-[550px] bg-center' >
     ...
     <Button className="my-8 shadow-xl font-semibold bg-blue-800 hover:bg-blue-500 hover:text-black " >Get Stated</Button>
